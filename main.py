...
macro_meals = mongo.meals_with_macros(protein = 30, calories = 300, sodium = 400, fat = 20, num = 20)
# pprint(macro_meals)

# Q2: Which recipes have 3 ingredients or less?
max_ingr_recipes = mongo.count_ingredients(max_ingredients=3, num=20)
...
# mongo.category_ratings(num = 20)

# Q7: Can I look for recipes with a specific ingredient?
# recipes = mongo.search_ingredient('bacon', num = 15)
# pprint(recipes)
...
# Q10: Which recipes have the fewest directions?
directions = mongo.few_directions(num = 20)
# pprint(directions)